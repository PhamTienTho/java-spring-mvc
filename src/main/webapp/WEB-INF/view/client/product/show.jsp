                                                    ...
                                                    <div class="col-md-6 col-lg-4 col-xl-4">
                                                        <div class="rounded position-relative fruite-item">
                                                            ...
                                                            <div
                                                                ...
                                                                <p style="font-size: 17px;">${product.shortDesc}</p>
                                                                <div class="d-flex flex-lg-wrap justify-content-center">
                                                                    <p class="text-dark fs-5 fw-bold mb-0"
                                                                        style="font-size: 15px; text-align: center; width: 100%; padding-bottom: 20px;">
                                            ...
                                            <nav aria-label="Page navigation example">
                                                <ul class="pagination justify-content-center">
                                                    <li class="page-item ${1 eq currentPage ? 'disabled' : ''}">
                                                        <a class="page-link" href="/product?page=${currentPage - 1}<c:if test='${not empty queryString}'>&${queryString}</c:if>">
                                                            Previous
                                                        </a>
                                                    </li>
                                                    <c:forEach begin="1" end="${totalPage}" varStatus="loop">
                                                        <li class="page-item">
                                                            <a class="${loop.index eq currentPage ? 'active page-link' : 'page-link'}"
                                                                href="/product?page=${loop.index}<c:if test='${not empty queryString}'>&${queryString}</c:if>">
                                                                ${loop.index}
                                                            </a>
                                                        </li>
                                                    </c:forEach>
                                                    <li class="page-item ${totalPage eq currentPage ? 'disabled' : ''}">
                                                        <a class="page-link" href="/product?page=${currentPage + 1}<c:if test='${not empty queryString}'>&${queryString}</c:if>">
                                                            Next
                                                        </a>
                                                    </li>
